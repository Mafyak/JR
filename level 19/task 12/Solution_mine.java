...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintStream tempPrintOutputer = System.out;

        ByteArrayOutputStream workingStream = new ByteArrayOutputStream();
        PrintStream printStream = new PrintStream(workingStream);
        System.setOut(printStream);

        testString.printSomething();
        String result = workingStream.toString().replaceAll("te", "??");

        System.setOut(tempPrintOutputer);
